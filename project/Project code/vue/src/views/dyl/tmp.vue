    ...
    <el-card class="box-card">
      <el-card class="card1">
        ...
        <el-upload
            ...
            :action="'http://localhost:9090/api/file/upload?token='+this.userEdge.token"
      ...
      <div style="position:absolute; margin-top: 138px; margin-left: 220px; color: #2f60bd;">点击上传图像</div>
      <el-card class="card2">
        ...
        <div style="padding-top: 30px;padding-left: 60px;">
          <div style="width: 200px; float:left;"><el-button type="warning" size="medium" @click="detectImage" :disabled="!uploadFile ||!chooseModel || !chooseDataset " plain>开始检测</el-button></div>
          <div style="width: 200px; padding-left: 150px; float:left;"><el-button type="success" size="medium" :disabled="!fileDetect" @click="downloadImage" plain>导出结果</el-button></div>
        </div>
